...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let employees = [
        (1_i64, "Alice", 30_i64, Some(7500.50_f64), true, Some(b"hello".as_slice())),
        (2_i64, "Bob", 25_i64, Some(6200.0_f64), false, None),
        (3_i64, "Charlie", 35_i64, None, true, Some(b"world".as_slice())),
    ];
    ...
    for row in &rows {
        ...
        let bio = match row.get(&5).and_then(Value::as_blob) {
